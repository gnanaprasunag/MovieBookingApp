...
const getCoordinates = async () => {
    ...
    const address = "BSR Mall, Thoraipakkam, Seevaram, Oggiyamduraipakkam, Chennai, Tamil Nadu 600097, India";
...
console.log("url in location",url)
  ...
  const nav= (lat, lon) => {
    const url = `https://www.google.com/maps?q=${12.949616},${80.240466}`;
  ...
  return (
    <div>
      ...
      <button onClick={nav }>Calculate now now Distance</button>
      {a && <p>Distance: {a} km</p>}
    </div>
  );
};
