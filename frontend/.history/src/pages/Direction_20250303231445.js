...
import React, { useState ,useEffectc} from 'react';
...
const getCoordinates = async () => {
  ...
  const calculateDistance = async () => {
    ...
    /* const url = `https://maps.googleapis.com/maps/api/geocode/json?address=${Formerly Jazz Cinemas, 2nd Floor, Phoenix Market City, Velachery Main Road, Velachery, Chennai, Tamil Nadu 600042, India}&key=${API_KEY}`;
