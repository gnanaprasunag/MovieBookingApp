...
const getCoordinates = async () => {
    const apiKey = "pk.2a08003926a37954102c9d1cb3d3d94c"; // Replace with your LocationIQ API key
  ...
  const calculateDistance = async () => {
    ...
    const url = `https://us1.locationiq.com/v1/directions/driving/${currentlon},${currentlat};${lon},${lat}?key=pk.2a08003926a37954102c9d1cb3d3d94c&overview=simplified&annotations=false`;
