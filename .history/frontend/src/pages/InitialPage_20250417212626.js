...
console.log("screen.width",window.screen.width)
    return(<div style={{backgroundSize:'contain',backgroundImage: `url('https://www.shutterstock.com/image-photo/cinema-mobile-app-tickets-online-260nw-2470120033.jpg')`}}>
