...
export default function App() {
  ...
  // ✅ Filter timeplace when data or movie/currentLocation changes
  useEffect(() => {
  ...
  // ✅ Collect previously visited locations by this user
  useEffect(() => {
  ...
  // ✅ Calculate distance to the clicked location
  useEffect(() => {
  ...
  // ✅ On location icon click, get lat/lon of the theater location
