...
console.log("2")
    ...
    return(<div className="movies-container"  style={{backgroundSize:'1280px',backgroundImage: `url('"C:\Users\Prasuna\Downloads\WhatsApp Image 2025-04-17 at 8.51.44 PM.jpeg"')`,backgroundSize:'cover'}}>
