        ...
        {movie && (
          <div className="movie-info" style={{border:"none"}}>
            ...
            <div style={{fontFamily:'cursive'}}>
              ...
              {rated==false ? <button style={{backgroundColor:"blue"}} onClick={()=>{user ? navigate('/ratingdetails',{state:{movie:movie, currentLocation}}) : navigate('/login')}}>Rate</button> : <h2 style={{fontSize:'25px',padding:'0px',margin:'auto auto'}}>Your rating:{rating}/5</h2>}
            </div>
            <h4>
