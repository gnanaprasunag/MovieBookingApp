...
const language=['Telugu','English','Hindi','Tamil','Korean','Hinglish','Malayalam']
    ...
    return(<div style={{backgroundImage: `url('https://thumbs.dreamstime.com/b/sparkling-glitter-background-vibrant-colors-reflecting-light-dreamy-atmosphere-beautiful-filled-shimmering-shades-350569283.jpg')`,backgroundSize:'auto'}}>
