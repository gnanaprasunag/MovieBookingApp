        ...
        <div className="actions-container">
            <div className='container1'>
                ...
                <div className="voice-search">
                    ...
                    >
                        {isListening ? <FontAwesomeIcon icon={faStop} style={{ color: 'white', fontSize: '24px' }} /> : <FontAwesomeIcon icon={faMicrophone} style={{fontSize:"40px",color:'ThreeDShadow'}}/>}
                    </button>
                </div>
            </div>
            ...
            <div className="secondpart">
                ...
                {currentLocation && <h3 style={{height:'60px',fontWeight:'50px',fontSize:'25px',paddingTop:'10px',margin:'9% 0',color:'#ffd700'}}>{currentLocation}</h3>}
