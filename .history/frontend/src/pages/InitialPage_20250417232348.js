...
console.log("screen.width",window.screen.width)
    return(<div>
    <div className="header-container" style={{backgroundColor:'rgb(246, 223, 91)'}}>
  {/* Left side: Image */}
  <div className="image-container" style={{borderRadius:'50px'}}>
    <img src={appImage} alt="App Logo" style={{ width: '500px',backgroundSize:'cover' ,borderRadius:'50px'}} />
  </div>
