        ...
        <div className="actions-container">
            ...
            <div className="secondpart">
                ...
                {localStorage.getItem('token') ? (
                    ...
                    <h3 style={{color:'#ffd700'}}>{user && `Hi, ${user.firstname}`}</h3>
                ...
                {currentLocation && <h3 style={{height:'60px',fontWeight:'50px',fontSize:'15px',paddingTop:'10px',margin:'9% 0',color:'#ffd700'}}>{currentLocation}</h3>}
