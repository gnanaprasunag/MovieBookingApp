...
console.log("2")
    ...
    return(<div className="movies-container"  style={{backgroundSize:'1280px',backgroundImage: `url('https://www.picture.lk/files/preview/800x1427/11733515120tipwxncjutq5sprwe90idiejp4lza2awlbhrmupqdmzadesygwmvlncet981jmfr1gkk2ereuynw2gei8kwvybqgxt0qmcszqmzh.jpg?type=free')`,backgroundSize:'cover'}}>
