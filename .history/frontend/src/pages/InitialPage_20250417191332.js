...
const language=['Telugu','English','Hindi','Tamil','Korean','Hinglish','Malayalam']
    ...
    return(<div>
    <div className="header-container" style={{ backgroundImage: `url('https://www.shutterstock.com/image-photo/abstract-blurred-blue-silver-glittering-shine-532523422')` }}>
  {/* Left side: Image */}
