...
console.log("screen.width",window.screen.width)
    return(<div style={{backgroundSize:'1280px',backgroundImage: `url('https://img.freepik.com/premium-photo/popcorn-bag-movie-ticket-black-background-ai-generated_866663-3088.jpg')`}}>
