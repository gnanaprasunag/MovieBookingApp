...
console.log("screen.width",window.screen.width)
    return(<div style={{backgroundSize:'contain',backgroundrepeat:'no-repeat',backgroundposition:'center',height:'100vh',backgroundImage: `url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRp2HbZuy0WGkS8ZC7-FKu-20kMRx4wAKR_xA&s')`}}>
