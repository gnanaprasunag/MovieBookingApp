...
console.log("2")
    ...
    return(<div className="movies-container"  style={{backgroundSize:'1280px',backgroundImage: `url('https://png.pngtree.com/thumb_back/fh260/background/20230617/pngtree-blank-movie-ticket-with-popcorn-bucket-filmstrip-clapperboard-and-camera-in-image_3623915.jpg')`,backgroundSize:'cover'}}>
