        ...
        {movie && (
          <div className="movie-info" style={{border:"none"}}>
            ...
            <div>
              ...
              {rated==false ? <button style={{backgroundColor:"blue"}} onClick={()=>{user ? navigate('/ratingdetails',{state:{movie:movie, currentLocation}}) : navigate('/login')}}>Rate</button> : <h2 style={{paddingLeft:'5px',maxWidth:'200px',padding:'0px',backgroundColor:"blue",border:'solid'}}>Your rating:{rating}/5</h2>}
            </div>
            <h4>
