...
export default function App(){
    ...
    return (
    <div style={{ background: 'linear-gradient(45deg,rgb(244, 91, 183),rgb(113, 109, 246))',}}>
    ...
    <div className="admin-dashboard">
        <button onClick={() => navigate('/moviedetails')}><span style={{fontSize:'20px'}}>Movies</span></button>
        <button onClick={() => navigate('/bookinghistory')}><span style={{fontSize:'20px'}}>Booking History</span></button>
        <button onClick={() => navigate('/listusers')}><span style={{fontSize:'20px'}}>Users</span></button>
        <button onClick={() => navigate('/castcrewdetails')}><span style={{fontSize:'20px'}}>Cast Crew</span></button>
        <button onClick={() => navigate('/timeplacedetails')}><span style={{fontSize:'20px'}}>Time Places</span></button>
        <button onClick={() => navigate('/allratings')}><span style={{fontSize:'20px'}}>Ratings</span></button>
    </div>
    )}
