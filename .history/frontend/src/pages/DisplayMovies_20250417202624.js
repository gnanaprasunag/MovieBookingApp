...
console.log("2")
    ...
    return(<div className="movies-container"  style={{backgroundSize:'1280px',backgroundImage: `url('https://media.istockphoto.com/id/1468911338/photo/top-view-of-colorful-traditional-holi-powder-in-bowls-isolated-on-dark-background-space-for.jpg?s=612x612&w=0&k=20&c=yp6YOz-FUG5xRSmA3DIr8FhYN0d-WwWP2MwVVOZUEAU=')`,backgroundSize:'cover'}}>
