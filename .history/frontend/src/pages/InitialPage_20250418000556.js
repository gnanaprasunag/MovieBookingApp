...
console.log("screen.width",window.screen.width)
  ...
  <div className="actions-container">
    ...
    <div className="voice-search">
      ...
      >
        {isListening ? <FontAwesomeIcon icon={faStop} style={{ color: 'white', fontSize: '24px' }} /> : <FontAwesomeIcon icon={faMicrophone} style={{fontSize:"40px",color:'green',textAlign:'left'}}/>}
      </button>
