...
export default function App(){
    ...
    return (
    <div style={{ background: 'linear-gradient(135deg,rgb(58, 100, 118), #203a43, #2c5364)',}}>
        ...
        <div className="actions-container">
            <div className='container1'>
                ...
                <div className="voice-search">
                    ...
                    >
                        {isListening ? <FontAwesomeIcon icon={faStop} style={{ color: 'white', fontSize: '24px' }} /> : <FontAwesomeIcon icon={faMicrophone} style={{fontSize:"40px",color:'blue'}}/>}
                    </button>
                </div>
            </div>
