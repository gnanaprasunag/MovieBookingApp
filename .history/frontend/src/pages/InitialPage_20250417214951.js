...
console.log("screen.width",window.screen.width)
    return(<div style={{backgroundSize:'cover',backgroundRepeat:'no-repeat',backgroundImage: `url('https://static.vecteezy.com/system/resources/thumbnails/009/482/424/small_2x/plain-stripped-pastel-color-wall-background-studio-for-product-display-post-vector.jpg')`}}>
