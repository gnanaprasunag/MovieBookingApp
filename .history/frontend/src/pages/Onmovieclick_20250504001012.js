        ...
        {movie && (
          <div className="movie-info" style={{border:"none"}}>
            ...
            <div>
              ...
              {rated==false ? <button style={{backgroundColor:"blue"}} onClick={()=>{user ? navigate('/ratingdetails',{state:{movie:movie, currentLocation}}) : navigate('/login')}}>Rate</button> : <h2 style={{backgroundColor:"blue",fontSize:'30px',border:'solid',padding:'0px',margin:'auto auto'}}>Your rating:{rating}/5</h2>}
            </div>
            <h4>
