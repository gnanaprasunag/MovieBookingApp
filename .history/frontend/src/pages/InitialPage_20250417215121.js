...
console.log("screen.width",window.screen.width)
    return(<div style={{backgroundSize:'contain',backgroundRepeat:'no-repeat',height:'100vh',backgroundImage: `url('https://cdn.pixabay.com/photo/2016/09/19/11/39/flat-1680090_640.png')`}}>
