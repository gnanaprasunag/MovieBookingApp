...
console.log("screen.width",window.screen.width)
    return(<div style={{backgroundRepeat:'no-repeat',backgroundImage: `url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvRnrlW6ZiZhrcXflrq-x_rOtU2m3w0C3QEw&s')`}}>
