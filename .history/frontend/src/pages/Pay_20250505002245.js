    ...
    try {
      ...
      const options = {
        ...
        handler: async (response) => {
          ...
          // 3️⃣ Update singledate bookings
          ...
          // 4️⃣ Send SMS (this will currently fail until Twilio credentials are fixed)
          try {
