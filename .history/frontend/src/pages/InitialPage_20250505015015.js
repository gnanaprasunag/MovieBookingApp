        ...
        <div className="actions-container">
            ...
            <div className="secondpart">
                ...
                {localStorage.getItem('token') ? (
                    ...
                    <FontAwesomeIcon icon={faUser} style={{ fontSize: '60px', color: '	#222222' }} />
                    </div>
                ) : (
                ...
                <div>
                    <button className="openbtn" style={{margin:'50% 0',marginRight:'30px',border:'solid' ,background:"linear-gradient(45deg, #cc5858, #78207e)"}} onClick={() => document.getElementById('menuSidepanel').style.width = '250px'}>
                    ☰ Menu
                    </button>
