...
const language=['Telugu','English','Hindi','Tamil','Korean','Hinglish','Malayalam']
    ...
    return(<div>
    <div className="header-container" style={{backgroundImage:"url('https://www.shutterstock.com/image-illustration/abstract-illustration-glittering-particles-dark-background-2513138247')"}}>
  {/* Left side: Image */}
