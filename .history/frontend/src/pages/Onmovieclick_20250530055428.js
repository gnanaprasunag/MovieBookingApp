...
setrating(ele.rating)
  ...
  return (
    <div style={{ background: 'linear-gradient(45deg,rgb(249, 130, 201),rgb(143, 140, 251))',}} className="movie-details-container">
        ...
        {movie && (
          <div className="movie-info" style={{border:"none"}}>
            ...
            <div style={{fontFamily:'cursive',color: "black"}}>
              <button  style={{background:'none'}} onClick={()=>{user ? navigate('/ratings',{state:{movie:movie}}) : navigate('/login')}}>&#11088;</button>
