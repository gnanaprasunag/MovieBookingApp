...
console.log("screen.width",window.screen.width)
    return(<div style={{backgroundSize:'contain',backgroundrepeat:'no-repeat',backgroundposition:'center',height:'140vh',width:'1280px',backgroundImage: `url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvRnrlW6ZiZhrcXflrq-x_rOtU2m3w0C3QEw&s')`}}>
