...
console.log("screen.width",window.screen.width)
    return(<div style={{backgroundSize:'contain',backgroundrepeat:'no-repeat',backgroundposition:'center',height:'1300vh',backgroundImage: `url('https://png.pngtree.com/thumb_back/fh260/background/20230625/pngtree-d-render-of-a-blank-cinema-ticket-with-a-bucket-of-image_3680160.jpg')`}}>
