...
console.log("screen.width",window.screen.width)
    return(<div style={{backgroundSize:'contain',backgroundrepeat:'no-repeat',backgroundposition:'center',height:'150vh',backgroundImage: `url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZzlimIp7r2s3gPZVZ5dvFdj7edJ1i2Dxuag&s')`}}>
