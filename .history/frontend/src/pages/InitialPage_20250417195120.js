...
const language=['Telugu','English','Hindi','Tamil','Korean','Hinglish','Malayalam']
    ...
    return(<div style={{backgroundImage: `url('https://png.pngtree.com/background/20210714/original/pngtree-beautiful-glitter-background-in-soft-light-color-picture-image_1236003.jpg')`,backgroundSize:'auto'}}>
