...
console.log("screen.width",window.screen.width)
    return(<div style={{backgroundSize:'contain',backgroundrepeat:'no-repeat',backgroundposition:'center',height:'1000vh',width:'1920px',backgroundImage: `url('https://miro.medium.com/v2/resize:fit:1400/0*HknVQR_lvyXqKUaM.jpg')`}}>
